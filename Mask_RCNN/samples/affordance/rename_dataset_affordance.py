...
# =================== new directory ========================
folder_to_save = '/data/Akeaveny/Datasets/part-affordance-dataset/ndds_and_real/temp6_val_syn/'
offset = 89 + 1
...
image_paths = ['/data/Akeaveny/Datasets/part-affordance-dataset/ndds_and_real/temp6_val_syn/000***']
