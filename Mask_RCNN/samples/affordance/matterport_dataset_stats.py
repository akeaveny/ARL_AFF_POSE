...
if __name__ == '__main__':
    ...
    # class NoResizeConfig(Affordance.AffordanceConfig):
    #     IMAGE_RESIZE_MODE = "none"
    #
    ...
    dataset.load_Affordance(args.dataset, subset="val")
    ...
    # image_id = "/data/Akeaveny/Datasets/part-affordance-dataset/ndds_and_real/formatted_real_val/00000_rgb.png"
    # image_id = 3
