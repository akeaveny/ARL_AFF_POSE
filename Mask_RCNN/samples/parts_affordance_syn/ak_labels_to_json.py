...
def write_to_json(instance_img, label_img, classes, img_number, folder_to_save, dataset_name):
    ...
    if count > 0:
        ...
        data[obj_name]['rgbfilename'] = folder_to_save + img_number + '_depth.png'
...
# ===================== json ====================
print('-------- VAL --------')
json_addr = '/data/Akeaveny/Datasets/part-affordance-dataset/ndds_and_real/fused_syn_val1.json'
...
# ===================== json ====================
print('-------- TRAIN --------')
json_addr = '/data/Akeaveny/Datasets/part-affordance-dataset/ndds_and_real/fused_syn_train1.json'
for i in range(min_img, max_img + 1):
# for i in img_list:
    print('\nImage: {}/{}'.format(i, max_img))
    count = 100000 + i
