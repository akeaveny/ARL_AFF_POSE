...
# # ===================== FUSE RGB + D ===========================
folder_to_load = 'Kinetic/'
data_path = '/data/Akeaveny/Datasets/test2/mixed/Kinetic/'
label_path = '/data/Akeaveny/Datasets/test2/mixed/Kinetic/*.cs.png'
