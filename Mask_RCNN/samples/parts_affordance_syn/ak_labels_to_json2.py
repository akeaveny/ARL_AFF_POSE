...
data_path = '/data/Akeaveny/Datasets/test4/'
json_folder = '/data/Akeaveny/Datasets/test4/json_files/'
class_id = [0, 1, 2, 3, 4, 5, 6, 7]
# =================== load from ========================
images_path1 = ['cup_01_Kinetic', 'cup_01/Kinetic/', 0, 9, 0]
# images_path2 = '/data/Akeaveny/Datasets/test4/cup_01/ZED/'
images_path2 = ['knife_01_Kinetic', 'knife_01/Kinetic/', 0, 9, 10]
# images_path4 = '/data/Akeaveny/Datasets/test4/knife_01/ZED/'
images_path3 = ['missing_Kinetic', 'missing/Kinetic/', 0, 9, 20]
image_paths = [images_path1, images_path2, images_path3]


for image_path in image_paths:

    json_addr_ = json_folder + image_path[0]
    folder_to_save = image_path[1]
    min_img = image_path[2]
    max_img = image_path[3]
    offset = image_path[4]
    ...
    # ===================== val ====================
    print('-------- VAL --------')
    json_addr = json_addr_ + '_val.json'
    print(json_addr)
    for i in val_idx:
        print("\nIteration: ", iteration)
        ...
        label_addr = data_path + folder_to_save + img_number + '.cs.png'
        # img_number = str(1000000 + i + offset)[1:]
    ...
    # ===================== train ====================
    print('-------- TRAIN --------')
    json_addr = json_addr_ + '_train.json'
    print(json_addr)
    for i in train_idx:
        print("\nIteration: ", iteration)
        print('Image: {}/{}'.format(i, max_img))
