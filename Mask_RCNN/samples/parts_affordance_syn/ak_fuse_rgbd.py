...
#
# # # ===================== FUSE RGB + D ===========================
# folder_to_load = 'test6/'
# data_path = '/data/Akeaveny/Datasets/test4/combined1/'
# label_path = '/data/Akeaveny/Datasets/test4/combined1/*.cs.png'
...
#     image_idx = image_idx.split(".cs.png")[0]
#     print(image_idx)
#
#     label_path = data_path + image_idx + ".cs.png"
#     label_img = imageio.imread(label_path)
#
#     rgb_path = data_path + image_idx + ".png"
#     rgb_img = np.array(imageio.imread(rgb_path))
#     # print("rgb_img: ", rgb_img.shape)
#
#     depth_path = data_path + image_idx + ".depth.16.png"
...
# # ===================== FUSE RGB + D ===========================
folder_to_load = 'combined1/'
data_path = '/data/Akeaveny/Datasets/test4/combined1/'
label_path = '/data/Akeaveny/Datasets/test4/combined1/*_label.png'
label_files = sorted(glob.glob(label_path))
print("label_files: ", len(label_files))
