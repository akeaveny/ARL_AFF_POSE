...
json_path = '/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/finetune/'
json_name = 'coco_finetune_'

data_path = '/data/Akeaveny/Datasets/part-affordance_combined/ndds4/'
val_path = 'finetune/umd1_val/'
train_path = 'finetune/umd1_train/'
...
for scene in scenes:
    ...
    if num_val == 0:
        ...
        images = data_path + folder_to_save + '*' + "_rgb.jpg"
        ...
        for idx, file in enumerate(files):
            ...
            if label_img.size == 0:
                ...
                data[obj_name]['filename'] = folder_to_save + img_number + '_rgb.jpg'
