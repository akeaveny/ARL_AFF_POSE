...
new_data_path = '/data/Akeaveny/Datasets/part-affordance_combined/ndds4/combined_tools5_'

####################
### Clutter
####################

# data_path = '/data/Akeaveny/Datasets/part-affordance_combined/ndds4/umd_affordance/clutter/'
# new_data_path = '/data/Akeaveny/Datasets/part-affordance_combined/ndds4/combined_clutter5_'
        ...
        for scene in scenes:
            for camera in cameras:
                ...
                for image_ext in image_exts:
                    ...
                    file_path = data_path + '*/' + scene + split + camera + '??????' + image_ext
