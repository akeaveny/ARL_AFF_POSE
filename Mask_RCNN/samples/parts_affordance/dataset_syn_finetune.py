...
class AffordanceConfig(Config):
    ...
    GPU_COUNT = 1
    IMAGES_PER_GPU = 2 # 5 for 'heads', 3 for 'all'
    ...
    # tools
    STEPS_PER_EPOCH = (22680 + 7521 + 7428 + 7182) * 1 // bs
    VALIDATION_STEPS = (5850 + 2034 + 2008 + 1951) * 1 // bs
    # STEPS_PER_EPOCH = (7521 + 7428 + 7182) // bs
    # VALIDATION_STEPS = (2034 + 2008 + 1951) // bs
    # STEPS_PER_EPOCH = (22680) // bs                 ### DR
    # VALIDATION_STEPS = (5850) // bs

    # STEPS_PER_EPOCH = (150) * 10 // bs                 ### DR
    # VALIDATION_STEPS = (45) * 10 // bs
    ...
    def load_Affordance(self, dataset_dir, subset):
        ...
        if subset == 'train':
            ...
            annotations.update(json.load(
               open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/syn_aff/bench/train_7521.json')))
            annotations.update(json.load(
               open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/syn_aff/floor/train_7428.json')))
            annotations.update(json.load(
            ...
            # #################
            annotations = json.load(
                 open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/syn_aff/dr/val_5850.json'))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/syn_aff/bench/val_2034.json')))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/syn_aff/floor/val_2008.json')))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/syn_aff/turn_table/val_1951.json')))
            # #################
            # annotations.update(json.load(
            ...
            # annotations.update(json.load(
            #     open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/finetune/coco_umd_val_finetune_45.json')))
        elif subset == 'test':
            annotations = {}
            print("------------------LOADING TEST!--------------------")
            annotations = json.load(
                    open('/data/Akeaveny/Datasets/part-affordance_combined/real/json/tools/rgb/umd/test_100.json'))
