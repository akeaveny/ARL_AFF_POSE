...
class AffordanceConfig(Config):
    ...
    STEPS_PER_EPOCH = (1951 + 672 + 672 + 672) // bs                 ### DR
    VALIDATION_STEPS = (494 + 168 + 168 + 168) // bs
    ...
    def load_Affordance(self, dataset_dir, subset):
        ...
        if subset == 'train':
            ...
            annotations = json.load(
               open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/scissors/dr/coco_train_1992.json'))
            ### annotations = {}
            annotations.update(json.load(
               open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/scissors/bench/coco_train_672.json')))
            annotations.update(json.load(
               open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/scissors/floor/coco_train_672.json')))
            annotations.update(json.load(
              open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/scissors/turn_table/coco_train_672.json')))
        if subset == 'val':
            print("\n************************** LOADING VAL **************************")
            annotations = json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/scissors/dr/coco_val_504.json'))
            ### annotations = {}
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/scissors/bench/coco_val_168.json')))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/scissors/floor/coco_val_168.json')))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/scissors/turn_table/coco_val_168.json')))
        elif subset == 'test':
            print("\n************************** LOADING TEST **************************")
            annotations = json.load(
                 open('/data/Akeaveny/Datasets/part-affordance_combined/real/json/tools/rgb/coco_scissors_test_80.json'))
            # annotations = json.load(
            #     open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/scissors/turn_table/coco_val_96.json'))
