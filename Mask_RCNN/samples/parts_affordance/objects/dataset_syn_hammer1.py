...
class AffordanceConfig(Config):
    ...
    MEAN_PIXEL = np.array([176.25, 170.10, 165.83])  ### SYN RGB DR + PR
    ...
    def load_Affordance(self, dataset_dir, subset):
        ...
        if subset == 'train':
            ...
            annotations = json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/hammer1/dr/coco_train_1056.json'))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/hammer1/bench/coco_train_348.json')))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/hammer1/floor/coco_train_319.json')))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/hammer1/turn_table/coco_train_348.json')))
        if subset == 'val':
            print("\n************************** LOADING VAL **************************")
            annotations = json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/hammer1/dr/coco_val_276.json'))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/hammer1/bench/coco_val_96.json')))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/hammer1/floor/coco_val_88.json')))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds4/json/rgb/objects/hammer1/turn_table/coco_val_96.json')))
        elif subset == 'test':
            print("\n************************** LOADING TEST **************************")
            annotations = json.load(
