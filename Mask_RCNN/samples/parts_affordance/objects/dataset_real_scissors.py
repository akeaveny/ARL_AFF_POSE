...
class AffordanceConfig(Config):
    ...
    GPU_COUNT = 1
    IMAGES_PER_GPU = 4  # 5 for 'heads', 3 for 'all'
    ...
    STEPS_PER_EPOCH = (1675) * 10 // bs
    VALIDATION_STEPS = (419) * 10 // bs
    ...
    def load_Affordance(self, dataset_dir, subset):
        ...
        if subset == 'train':
            ...
            annotations = json.load(
               open('/data/Akeaveny/Datasets/part-affordance_combined/real/json/tools/rgb/objects/coco_scissors_train_1675.json'))
        if subset == 'val':
            print("\n************************** LOADING VAL **************************")
            annotations = json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/real/json/tools/rgb/objects/coco_scissors_val_419.json'))
        elif subset == 'test':
            print("\n************************** LOADING TEST **************************")
            annotations = json.load(
