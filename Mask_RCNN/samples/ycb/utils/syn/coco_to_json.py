...
def create_sub_mask_annotation(sub_mask, class_id, label_img, rgb_img):
    ...
    # sub_mask = sub_mask.crop((96, 112, 384, 528)).resize((1280, 1280))
    ...
    #
    # for y in range(0, edge_sobel.shape[1]):
    #     for x in range(0, edge_sobel.shape[0]):
    #         if edge_sobel[x, y] != 0:
    #             x_list.append(y)
    #             y_list.append(x)
    #
    ...
    # dst, thresh = cv2.threshold(img, 20, 200, cv2.THRESH_BINARY)
...
dataset_name = 'YCB'
data_path = '/data/Akeaveny/Datasets/ycb_syn/'

######################
# tools
######################
json_path = '/data/Akeaveny/Datasets/ycb_syn/json/rgb/tools/'
val_path = 'combined_tools3_val/'
train_path = 'combined_tools3_train/'
test_path = 'combined_tools3_test/'

######################
# clutter
######################
# json_path = '/data/Akeaveny/Datasets/ycb_syn/json/rgb/clutter/'
# val_path = 'combined_clutter3_val/'
# train_path = 'combined_clutter3_train/'
# test_path = 'combined_clutter3_test/'

image_ext = '_label.png' ### object ids or affordances
class_id = np.arange(0, 31+1, 1)
...
for scene in scenes:
    ...
    #     #  Resize
    #     ##############################
    #     # rgb_img = rgb_img.crop((96, 112, 384, 528)).resize((1280, 1280))
    #     # label_img = label_img.crop((96, 112, 384, 528)).resize((1280, 1280))
    #
    #     # rgb_img.show()
    #     # label_img.show()
    #
    ...
    json_addr = json_path + scene + 'coco_test_' + np.str(len(files)) + '.json'
    print("json_addr: ", json_addr)
    for idx, file in enumerate(files):
