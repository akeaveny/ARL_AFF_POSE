...
# COCO_WEIGHTS_PATH = '/home/akeaveny/catkin_ws/src/Object-RPE/Mask_RCNN/mask_rcnn_coco.h5'
# Directory to save logs and model checkpoints, if not provided
# through the command line argument --logs
DEFAULT_LOGS_DIR = os.path.join(ROOT_DIR, "logs")
# DEFAULT_LOGS_DIR = '/home/akeaveny/catkin_ws/src/Object-RPE/Mask_RCNN/logs'
...
class YCBDataset(utils.Dataset):
    ...
    def load_YCB(self, dataset_dir, subset):
        ...
        if subset == 'train':
            print("------------------TRAIN------------------")
            annotations = json.load(open(os.path.join(dataset_dir, "via_region_data_combined_val.json")))
        elif subset == 'val':
            print("------------------VAL--------------------")
            annotations = json.load(open(os.path.join(dataset_dir, "via_region_data_combined_val.json")))
