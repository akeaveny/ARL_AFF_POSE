...
def detect_and_get_masks(model, data_path, num_frames):
    classes_file_dir = '/data/Akeaveny/Datasets/pringles/pringles_config/dataset_config/classes.txt'
    class_id_file_dir = '/data/Akeaveny/Datasets/pringles/pringles_config/dataset_config/class_ids.txt'
