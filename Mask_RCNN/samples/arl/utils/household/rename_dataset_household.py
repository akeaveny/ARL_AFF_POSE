...
# # TOOLS
# ############################
# data_path = '/data/Akeaveny/Datasets/arl_dataset/test/tools/arl_test_tools_2/'
# new_data_path = '/data/Akeaveny/Datasets/arl_dataset/combined_household_tools_1_'

############################
# CLUTTER
############################
data_path = '/data/Akeaveny/Datasets/arl_dataset/real_household/clutter/arl_test_clutter_2/'
new_data_path = '/data/Akeaveny/Datasets/arl_dataset/combined_household_clutter_1_'
