...
# aff
######################
json_path = '/data/Akeaveny/Datasets/arl_scanned_objects/ARL/json/real/'
json_name = 'coco_tools_'
val_path = 'combined_real_tools1_val/'
train_path = 'combined_real_tools1_train/'
test_path = 'combined_real_tools1_test/'
