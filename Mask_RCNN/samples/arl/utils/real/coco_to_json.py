...
# val_path = 'combined_real_tools_4_val/'
# train_path = 'combined_real_tools_4_train/'
# test_path = 'combined_real_tools_4_test/'
#
# json_path = '/data/Akeaveny/Datasets/arl_dataset/json/real/tools/'
