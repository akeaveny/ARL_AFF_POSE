...
if __name__ == '__main__':
    ...
    data_paths = [
            '/data/Akeaveny/Datasets/arl_dataset/combined_real_tools_4_',
            '/data/Akeaveny/Datasets/arl_dataset/combined_real_clutter_4_',
                  ]
            ...
            for scene in scenes:
                for image_ext in image_exts1:
                    ...
                    for file in files:
                        ...
                        affordance_label_addr = data_path + split + scene + filenum + '_object_id.png'
