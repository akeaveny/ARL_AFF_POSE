...
# =================== new directory ========================
# 0.
data_path = '/data/Akeaveny/Datasets/arl_scanned_objects/ARL/LabelFusion/logs/'
new_data_path = '/data/Akeaveny/Datasets/arl_scanned_objects/ARL/combined_real_tools1_'

# =================== load from ========================
subfolder = 'images/'
objects = [
    'hammer_672x376_00/' + subfolder,
    'hammer_672x376_01/' + subfolder,
    'spatula_672x376_00/' + subfolder,
    'spatula_672x376_01/' + subfolder,
    ]
