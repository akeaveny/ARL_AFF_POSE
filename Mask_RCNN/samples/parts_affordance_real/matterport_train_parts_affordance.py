...
def train(model):
    ...
    """Train the model."""
    # Training dataset.
    dataset_train = PartsAffordance.PartsAffordanceDataset()
    dataset_train.load_Affordance(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = PartsAffordance.PartsAffordanceDataset()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect PartsAffordance.')
