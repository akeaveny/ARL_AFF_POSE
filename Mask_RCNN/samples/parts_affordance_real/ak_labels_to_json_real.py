...
def write_to_json(instance_img, label_img, classes, img_number, folder_to_save, dataset_name):
    ...
    if count > 0:
        ...
        data[obj_name]['filename'] = folder_to_save + img_number + '_rgb.jpg' # TODO
...
# folder_to_save = 'real/combined_tools/'
...
# train_split = 0.7
# idx = np.arange(0, max_img, 1)
# train_idx = np.random.choice(idx, size=int(max_img*train_split), replace=False)
# val_idx = np.delete(idx, train_idx)
# # train_idx = np.random.choice(idx, size=int(700), replace=False)
# # val_idx = np.random.choice(idx, size=int(300), replace=False)
#
...
# # ===================== val ====================
# print('-------- VAL --------')
# json_addr = '/data/Akeaveny/Datasets/part-affordance_combined/real/json/rgb/tools_val.json'
# for i in val_idx:
#     print('\nImage: {}/{}'.format(iteration, np.squeeze(val_idx.shape)))
#     count = 1000000 + i
...
# # ===================== train ====================
# print('-------- TRAIN --------')
# json_addr = '/data/Akeaveny/Datasets/part-affordance_combined/real/json/rgb/tools_train.json'
# for i in train_idx:
#     print('\nImage: {}/{}'.format(iteration, np.squeeze(train_idx.shape)))
#     count = 1000000 + i
#     img_number = str(count)[1:]
#     label_addr = data_path + img_number + '_label.png'
#
...
folder_to_save = 'combined_tools_test_hammer/'
dataset_name = 'Affordance'
save_rgb = '_rgb.png'
# save_rgb = '_fused.png'
...
# ===================== TEST ====================
print('-------- TEST --------')
json_addr = '/data/Akeaveny/Datasets/part-affordance_combined/real/json/rgb/tools_test_hammer.json'
for file in files:
    ...
    label_addr = data_path + str_num + '_label.png'
    ...
    if label_img.size == 0:
        ...
        write_to_json(label_img, label_img, class_id, str_num, folder_to_save, dataset_name)
    iteration += 1
