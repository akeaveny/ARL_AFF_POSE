...
# ===================== train ====================
print('-------- TRAIN --------')
json_addr = '/data/Akeaveny/Datasets/part-affordance-dataset/real/clutter_train.json'
for i in train_idx:
    print("\nIteration: ", iteration)
...
# # ===================== val ====================
# print('-------- VAL --------')
# json_addr = '/data/Akeaveny/Datasets/part-affordance-dataset/real/clutter_val.json'
# for i in val_idx:
