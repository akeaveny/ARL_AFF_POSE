...
'''YCB Objects'''
# =================== new directory ========================
folder_to_save = '/data/Akeaveny/Datasets/YCB_Affordance/Train/'
images_path1 = '/data/Akeaveny/Datasets/YCB_Video_Dataset/data/0003/0001??'
images_path2 = '/data/Akeaveny/Datasets/YCB_Video_Dataset/data/0006/0001??'
images_path3 = '/data/Akeaveny/Datasets/YCB_Video_Dataset/data/0014/0001??'
images_path4 = '/data/Akeaveny/Datasets/YCB_Video_Dataset/data/0024/0001??'
images_path5 = '/data/Akeaveny/Datasets/YCB_Video_Dataset/data/0026/0001??'
images_path6 = '/data/Akeaveny/Datasets/YCB_Video_Dataset/data/0041/0001??'
images_path7 = '/data/Akeaveny/Datasets/YCB_Video_Dataset/data/0050/0001??'

# images_path1 = '/data/Akeaveny/Datasets/YCB_Video_Dataset/data/00??/00005[0-2]'
image_paths = [images_path1, images_path2, images_path3, images_path4, images_path5, images_path6, images_path7]
offset = 0
...
image_ext10 = '-box.txt'
image_ext11 = '-color.png'
image_ext12 = '-depth.png'
image_ext13 = '-label.png'
image_ext14 = '-meta.mat'

image_exts = [image_ext10, image_ext11, image_ext12, image_ext13, image_ext14]
...
for image_path in image_paths:
    ...
    for image_ext in image_exts:
        ...
        for idx, file in enumerate(files):
            ...
            # /data/Akeaveny/Datasets/YCB_Video_Dataset/data/0091/
            folder = file.split("/data/Akeaveny/Datasets/YCB_Video_Dataset/data/")[1]
            ...
            if image_ext == '_rgb.jpg':
                ...
                new_file_name = folder_to_save + np.str(image_num) + folder + image_ext
