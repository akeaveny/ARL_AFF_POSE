...
def train(model, args):
    ...
    """Train the model."""
    # Training dataset.
    dataset_train = ARLElevator.ARLElevatorDataset()
    dataset_train.load_ARLElevator(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = ARLElevator.ARLElevatorDataset()
    dataset_val.load_ARLElevator(args.dataset, "val")
    dataset_val.prepare()
