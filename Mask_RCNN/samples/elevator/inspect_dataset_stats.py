...
parser.add_argument('--dataset', required=False, default='/data/Akeaveny/Datasets/elevator_dataset/',
                    type=str,
                    metavar="/path/to/ARLElevator/dataset/")
...
# class RandomCropConfig(ARLElevator.ARLElevatorConfig):
...
if __name__ == '__main__':
    ...
    config = ARLElevator.ARLElevatorConfig()

    dataset = ARLElevator.ARLElevatorDataset()
    dataset.load_ARLElevator(args.dataset, subset=args.dataset_split)
    ...
    #         # iaa.CoarseDropout((0.03, 0.15), size_percent=(0.01, 0.05), per_channel=0.2),
    #     ]),
