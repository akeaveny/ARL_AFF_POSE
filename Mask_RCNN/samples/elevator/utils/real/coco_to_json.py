...
data_path = '/data/Akeaveny/Datasets/elevator_dataset/'
val_path = 'combined_real_tools_1_val/'
train_path = 'combined_real_tools_1_train/'
test_path = 'combined_real_tools_1_test/'

json_path = '/data/Akeaveny/Datasets/elevator_dataset/json/real/'
...
###
# NUM_IMAGES = 1500
num_val   = 4 #int(NUM_IMAGES*0.2)
num_train = 4 #int(NUM_IMAGES*0.8)
num_test  = 4
