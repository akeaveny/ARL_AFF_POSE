...
# parser.add_argument('--dataset_root', default='./datasets/linemod/Linemod_preprocessed', help="dataset root dir (''YCB_Video Dataset'')")
parser.add_argument('--dataset_root', default='/data/Akeaveny/Datasets/YCB_Video_Dataset', help="dataset root dir (''YCB_Video Dataset'')")
...
if __name__ == '__main__':
    ...
    dataset = SegDataset(opt.dataset_root, '/data/Akeaveny/Datasets/YCB_Video_Dataset/ycb_config/dataset_config/train_data_list.txt', True, 5000)
    dataloader = torch.utils.data.DataLoader(dataset, batch_size=opt.batch_size, shuffle=True, num_workers=int(opt.workers))
    test_dataset = SegDataset(opt.dataset_root, '/data/Akeaveny/Datasets/YCB_Video_Dataset/ycb_config/dataset_config/test_data_list.txt', False, 1000)
