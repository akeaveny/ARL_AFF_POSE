...
class PoseDataset(data.Dataset):
    def __init__(self, mode, num_pt, add_noise, root, noise_trans, refine):
        ...
        if mode == 'train':
            self.path = '/home/akeaveny/catkin_ws/src/object-rpe-ak/DenseFusion/datasets/ycb_syn/dataset_config/train_data_list.txt'
        elif mode == 'test':
            self.path = '/home/akeaveny/catkin_ws/src/object-rpe-ak/DenseFusion/datasets/ycb_syn/dataset_config/test_data_list.txt'
        print(self.path)
        ...
        self.norm = transforms.Normalize(mean=[110.41/255, 108.17/255, 128.26/255],
        ...
        self.symmetry_obj_idx = [15, 23, 28, 30, 31]
        self.num_pt_mesh_small = 500
        self.num_pt_mesh_large = 800  # TODO: powerdrill has 800 ???
        self.refine = refine
    ...
    def __getitem__(self, index):
        ...
        # TODO (ak): scale depth
        depth = np.array(Image.open('{0}/{1}_depth.png'.format(self.root, self.list[index]))) * self.NDDS_DEPTH_CONST
        ...
        test_folder = '/data/Akeaveny/Datasets/ycb_syn/test_densefusion/'
        ...
        ### display mask
        # mask_gt = np.array(mask.copy(), dtype=np.uint8)
        ...
        cam_translation = np.array(meta['cam_translation' + meta_idx][0])  # in [mm]
        cam_translation /= 1e3  # now in [m]
