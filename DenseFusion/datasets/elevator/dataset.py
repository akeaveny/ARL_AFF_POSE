...
class PoseDataset(data.Dataset):
    def __init__(self, mode, num_pt, add_noise, root, noise_trans, refine):
        ...
        if mode == 'train':
            self.path = '/home/akeaveny/catkin_ws/src/object-rpe-ak/DenseFusion/datasets/elevator/dataset_config/data_lists/elevator_train_data_list.txt'
        elif mode == 'test':
            self.path = '/home/akeaveny/catkin_ws/src/object-rpe-ak/DenseFusion/datasets/elevator/dataset_config/data_lists/elevator_val_data_list.txt'
        print(self.path)
        ...
        class_file = open(
            '/home/akeaveny/catkin_ws/src/object-rpe-ak/DenseFusion/datasets/elevator/dataset_config/classes.txt')
        class_id_file = open(
            '/home/akeaveny/catkin_ws/src/object-rpe-ak/DenseFusion/datasets/elevator/dataset_config/classes_ids.txt')
        ...
        for class_id in self.class_IDs:
            ...
            if not class_input:
                break
            input_file = open(
                '/data/Akeaveny/Datasets/elevator_dataset/models/DenseFusion/{0}.xyz'.format(class_input[:-1]))
            self.cld[class_id] = []
            while 1:
                input_line = input_file.readline()
                if not input_line:
    ...
    def __getitem__(self, index):
        ...
        test_folder = '/data/Akeaveny/Datasets/elevator_dataset/test_densefuion/'
