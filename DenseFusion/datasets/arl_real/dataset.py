...
class PoseDataset(data.Dataset):
    def __init__(self, mode, num_pt, add_noise, root, noise_trans, refine):
        ...
        if mode == 'train':
            # self.path = '/home/akeaveny/catkin_ws/src/object-rpe-ak/DenseFusion/datasets/arl_real/dataset_config/train_data_list.txt'
            self.path = '/home/akeaveny/catkin_ws/src/object-rpe-ak/DenseFusion/datasets/arl_real/dataset_config/train_data_list_combined.txt'
        elif mode == 'test':
            # self.path = '/home/akeaveny/catkin_ws/src/object-rpe-ak/DenseFusion/datasets/arl_real/dataset_config/val_data_list.txt'
            self.path = '/home/akeaveny/catkin_ws/src/object-rpe-ak/DenseFusion/datasets/arl_real/dataset_config/val_data_list_combined.txt'
        print(self.path)
        ...
        # self.norm = transforms.Normalize(mean=[112.83933655/255, 108.60317768/255, 100.21422303/255],   ### REAL
        #                                  std=[59.73553193/255, 63.61142929/255, 70.06586743/255])
        self.norm = transforms.Normalize(mean=[148.09211299/255, 141.1135562/255, 142.44441493/255],    ### COMBINED
                                         std=[47.60440004/255, 45.04527408/255, 40.02458134/255])
