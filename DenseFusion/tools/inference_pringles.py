...
data_path = '/data/Akeaveny/Datasets/pringles/zed/inference/'
folder_to_save = "combined/"
mask_idxs = np.array([4])

poses_path = dataset_config_dir + 'DenseFusion_Poses.txt'
...
while 1:
    ...
    input_file = open('/data/Akeaveny/Datasets/pringles/pringles_config/dataset_config/model_Pringles_20180815_173653581.xyz')
    cld[class_id] = []
    while 1:
...
for now in mask_idxs:
    ...
    mask_addr = data_path + folder_to_save + str_num + ".cs.png"
