...
parser.add_argument('--dataset', required=False, default='/data/Akeaveny/Datasets/ycb_syn/',
                    type=str,
...
norm_ = transforms.Normalize(mean=[110.41 / 255, 108.17 / 255, 128.26 / 255],
                                 std=[40.90727774 / 255, 44.04699447 / 255, 38.46340635 / 255])
...
for run_idx, idx in enumerate(test_idx):
    ...
    depth = np.array(Image.open(depth_addr)) * NDDS_DEPTH_CONST
