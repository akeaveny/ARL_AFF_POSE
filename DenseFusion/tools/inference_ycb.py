...
# ================== Dataset =========================
norm = transforms.Normalize(mean=[0.188, 0.205, 0.264], std=[0.206, 0.215, 0.238])

dataset_config_dir = '/data/Akeaveny/Datasets/YCB_Video_Dataset/ycb_config/dataset_config/'
class_names_file_dir = '/data/Akeaveny/Datasets/YCB_Video_Dataset/ycb_config/dataset_config/classes.txt'
class_ids_file_dir = '/data/Akeaveny/Datasets/YCB_Video_Dataset/ycb_config/dataset_config/class_ids.txt'

data_path = '/data/Akeaveny/Datasets/YCB_Video_Dataset/'
folder_to_save = "train_combined/"
mask_idxs = np.array([31, 33, 36])

poses_path = "/data/Akeaveny/Datasets/YCB_Video_Dataset/DenseFusion_Poses.txt"
...
for now in mask_idxs:
    ...
    # count = now
    str_num = str(count)[1:]
    # str_num = np.str(0) + np.str(now)
    f.write(str_num)
    f.write("\n")

    rgb_addr = data_path + folder_to_save + "images/" + str_num + "-color.png"
    depth_addr = data_path + folder_to_save + "images/" + str_num + "-depth.png"
    ...
    # depth = depth[50:530, 100:740]
    # img = img[50:530, 100:740, :]  # height x width
    # masks = masks[50:530, 100:740]
