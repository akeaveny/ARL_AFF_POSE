...
# import model as modellib, utils, visualize
...
class AffordanceConfig(Config):
    ...
    MEAN_PIXEL = np.array([93.19925594, 90.10199632, 87.27872183])
    ...
    def load_Affordance(self, dataset_dir, subset):
        ...
        if subset == 'train':
            ...
            annotations = json.load(
               open('/data/Akeaveny/Datasets/part-affordance_combined/ndds2/json/rgb/dr/train_175.json'))
            # annotations = {}
            # annotations.update(json.load(
            #     open('/data/Akeaveny/Datasets/part-affordance_combined/ndds2/json/missing/missing.json')))
            annotations.update(json.load(
               open('/data/Akeaveny/Datasets/part-affordance_combined/ndds2/json/rgb/bench/train_175.json')))
            annotations.update(json.load(
               open('/data/Akeaveny/Datasets/part-affordance_combined/ndds2/json/rgb/floor/train_175.json')))
            annotations.update(json.load(
               open('/data/Akeaveny/Datasets/part-affordance_combined/ndds2/json/rgb/turn_table/train_175.json')))
        elif subset == 'val':
            print("------------------LOADING VAL!--------------------")
            annotations = json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds2/json/rgb/dr/val_75.json'))
            # annotations = {}
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds2/json/rgb/bench/val_75.json')))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds2/json/rgb/floor/val_75.json')))
            annotations.update(json.load(
                open('/data/Akeaveny/Datasets/part-affordance_combined/ndds2/json/rgb/turn_table/val_75.json')))
        # elif subset == 'test':
        #     annotations = json.load(
        #         open('/data/Akeaveny/Datasets/part-affordance_combined/real/json/rgb/tools_test_hammer.json'))
